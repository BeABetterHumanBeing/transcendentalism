...
(defn error-page-img
  ...
  (case status
    404 "/void.png"
    ; TODO - add an image for 501, not implemented. Say a hammer and sickle
    "/void.png"))

(defn error-page-name
  [status]
  (case status
    404 "NOT FOUND"
    501 "NOT IMPLEMENTED"
